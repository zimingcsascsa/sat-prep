...
document.getElementById('btn-mark').textContent = isMarked ? 'flag Unmark' : 'flag Mark for Review';
...
checkBtn.textContent = 'check Check Answer';
...
const statusIcon = isSkipped ? '⊘' : (isCorrect ? 'check' : '✗');
